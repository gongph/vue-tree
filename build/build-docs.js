...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buttonDoc = __webpack_require__(5);
	
	var _buttonDoc2 = _interopRequireDefault(_buttonDoc);
	
	var _treeDoc = __webpack_require__(11);
	...
	new _vue2.default({
		el: 'body',
		components: {
			containerDoc: _container2.default,
			buttonDoc: _buttonDoc2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-a75d61de/container.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] docs\\example\\buttonDoc.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-2220ae94/buttonDoc.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		methods: {
			moreLink: function moreLink() {
				alert('to more conent!');
			}
		}
	};
	// </script>
...
/***/ function(module, exports) {
	...
	// <template>
	// 	<button class="btn btn-primary btn-sm" @click="callback">
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-f83eee6c/treeDoc.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _treeSet = __webpack_require__(13);
	...
	// <template>
	// 	<neris-tree url="http://ajaxTree.com" async></neris-tree>
	// </template>
	//
	// <script>
	exports.default = {
		components: {
			nerisTree: _treeSet2.default
		}
	};
	// </script>
	/* generated by vue-loader */
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-095287f9/treeSet.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.parent{\n\tfont-weight: bold;\n\tcolor: green;\n}\n", "", {"version":3,"sources":["/./src/components/tree.vue?a7b6670e"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA0CA;CACA,kBAAA;CACA,aAAA;CACA","file":"tree.vue","sourcesContent":["<template>\n\t<li>\n\t\t<a href=\"#\" :class=\"{parent: isParent}\" @click=\"toggle\">\n\t\t\t{{model.name}}\n\t\t\t<span v-if=\"isParent\">{{open ? '[-]' : '[+]'}}</span>\n\t\t</a>\n\t\t<ul v-if=\"isParent\" v-show=\"open\">\n\t\t\t<item v-for=\"model in model.childrens\" :model=\"model\">\n\t\t\t\t{{model.name}}\n\t\t\t</item>\n\t\t</ul>\n\t</li>\n</template>\n\n<script>\n\texport default {\n\t\tname: 'item',\n\t\tprops: {\n\t\t\tmodel: {\n\t\t\t\ttype: Object\n\t\t\t}\n\t\t},\n\t\tdata() {\n\t\t\treturn {\n\t\t\t\topen: false\n\t\t\t}\n\t\t},\n\t\tcomputed: {\n\t\t\tisParent() {\n\t\t\t\treturn this.model.childrens && this.model.childrens.length;\n\t\t\t}\n\t\t},\n\t\tmethods: {\n\t\t\ttoggle() {\n\t\t\t\tif(this.isParent) this.open = !this.open;\n\t\t\t}\n\t\t}\n\n\t}\n</script>\n\n<style>\n\t.parent{\n\t\tfont-weight: bold;\n\t\tcolor: green;\n\t}\n</style>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_mockjs2.default.mock('http://ajaxTree.com', {
		'models': {
			name: '根节点',
			childrens: [{ name: '父节点1' }, { name: '父节点2', childrens: [{ name: '子节点2.1' }, { name: '子节点2.2', childrens: [{ name: '子节点2.2.1' }] }] }]
		}
	});
